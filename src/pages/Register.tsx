...
export const Register: React.FC = () => {
  ...
  return (
    <div className=' relative max-w-5xl flex justify-center items-center h-screen bg-cover bg-center' style={{ backgroundImage: `url('https://s3-alpha-sig.figma.com/img/c230/ffba/520fab60716f712257d7f6a7fc48a42f?Expires=1730073600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=mbNGe5cnciSearQhKP2TR~WMvIdiSi38k2DKnj9az4oIk~mkYPlBew~n6b49iJlGa1MfnLR99ignFHZWU834sozpXh0ZES44LHTkQ~LaiPX617O9vsGdLOdBzv~HfyHC4i-gxBdZJ2-C8~dWWDlhfVZzmyYsfCpk3l9--rQ98~X9rgcTKOzt219SqTjuf61A81vMm8zHed3JRxZAWpgvz2cg1aRW59eJm4F35rTeWhNY~WCR3y8J7WNm3lUYI6JqRMw2~D2vx6ZCJ4LNuHSKcJSt0dJWnwlIJ1V7iGfrHlbC5Cia~DlDhNel5OLxptWbH0JlwdpO0trcmk4kZK0hog__')` }}>
